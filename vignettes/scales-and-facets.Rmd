...
returned from `fun` argument or the ordering index wrapped with `I()`. Here we
calculate the final index by the means and reorder the heatmap columns.
