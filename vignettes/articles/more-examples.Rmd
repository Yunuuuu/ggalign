...
vignette: >
  %\VignetteIndexEntry{ComplexHeatmap: more examples}
...
ggstack(data = mat_scaled, "h") +
    ...
    ggheatmap(action = plot_action(free_spaces = "l")) +
    ...
    anno_top(action = plot_action(free_spaces = "lr")) +
