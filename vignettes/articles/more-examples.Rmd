...
ggstack(data = mat_scaled) +
  ...
  # we reset heatmap context into heatmap body, in this way,
  # `&` will add elemnets for this heatmap and heatmap annotation simutaneously
  hmanno() +
  ...
  # add another heatmap
  ggheatmap(expr$type, width = unit(2, "cm"), free_sizes = "y") +
