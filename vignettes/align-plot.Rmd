...
layout (`aes(y = .data$.y)` for horizontal stack or `aes(x = .data$.x)` for
vertical stack). See `ggplot2 specification` in `?align_gg` for details.
...
See `ggplot2 specification` in `?align_gg()` for the data details.
