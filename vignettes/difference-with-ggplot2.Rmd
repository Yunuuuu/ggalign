---
title: "Difference with ggplot2"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Difference with ggplot2}
...
facets, and coordinates are handled in the the axes used for alignment. This
vignette highlights the differences in syntax between `ggalign` and `ggplot2`.

Following syntax applies to all `align_*` functions which would add a plot area,
and the main plot in `quad_layout()` when need alignment.
