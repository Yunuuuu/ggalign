...
- `+`: add elements to the active plot in the active layout.
- `-`: add elements to all plots in the active layout and the nested layout of
the active layout.
- `&`: add elements to all plots for the layout.

For `quad_layout()`/`ggheatmap()`, 
...
actions for all plots in the layout. Additionally, `plot_align()` can be
