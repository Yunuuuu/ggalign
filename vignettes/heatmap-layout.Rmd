...
function with the `res` argument. By default, the `res` will match the
resolution of the current device, but specifying a different value can reduce
the resolution of the rasterized heatmap body, potentially improving performance
compared to using the pure `geom_raster()` approach.
```{r}
ggheatmap(small_mat, filling = NULL) +
