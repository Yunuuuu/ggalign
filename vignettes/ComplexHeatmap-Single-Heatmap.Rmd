---
title: "ComplexHeamtap-Single-Heatmap"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{ComplexHeamtap-Single-Heatmap}
...
Heatmap cell border, we just decrease the cell width and height. 
```{r}
...
You can also use `color` aesthetic to specify the cell border color and
