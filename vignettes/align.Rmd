---
title: "Setup layout order and panel and Add plot into layout"
...
The package provides a range of `align_*` functions that enable control over the
layout. Specifically, these functions allow for the manipulation of axis order
in the layout, as well as partitioning along a single axis into multiple panel.
Additionally, some of these functions have the capability to add plots. 
