...
bottom, and right sides, but all annotations here use `stack_free()`, meaning they
don't align observations.
...
facetting for the main plot, which also needs to be applied to the annotations
