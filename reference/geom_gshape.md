...
in which, we can provide a list of grobs or functions that define how
each value should be drawn. Any ggplot2 aesthetics can be used as the
arguments.
...
`geom_gshape()` understands the following aesthetics. Required
