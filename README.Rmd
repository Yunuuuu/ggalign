...
cat(" 1. For the full reference documentation, visit: <https://yunuuuu.github.io/ggalign/>", sep = "\n\n")
cat(" 2. The complete tutorial is available at: <https://yunuuuu.github.io/ggalign-book/>", sep = "\n")
```
