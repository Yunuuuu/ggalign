...
typical workflow includes: 
 ...
 - Initialize the layout using `quad_layout()` (`ggheatmap()`/`ggside()`) or
 `stack_layout()` (`ggstack()`).
...
For documents of the release version, please see <`r sprintf("%s/", params$release)`>, for
documents of the development version, please see <`r sprintf("%s/", params$devel)`>.
...
`r sprintf("![](%s/articles/oncoplot_files/figure-html/unnamed-chunk-19-1.png)", url)`
