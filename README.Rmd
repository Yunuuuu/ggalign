...
```{r echo=FALSE}
url <- params[["book"]]
altmetric <- '<script type="text/javascript" src="https://d1bxh8uas1mnw7.cloudfront.net/assets/embed.js"></script><div class="altmetric-embed" align="right" height="139" data-badge-type="donut" data-altmetric-id="173956809"></div>'
```
...
## Why use `ggalign`? `r if (knitr::is_html_output(excludes = "gfm")) { altmetric }`
