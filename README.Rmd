...
```{r, results="asis", echo=FALSE, eval=knitr::is_html_output(excludes = "gfm")}
...
cat('<div class="altmetric-embed" align="left" height="139" data-badge-type="donut" data-altmetric-id="173956809"></div>', sep = "\n")
```
