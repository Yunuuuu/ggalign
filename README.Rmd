...
- Seamlessly integrate ggplot2 `geoms`, `stats`, and `scales` into your layouts.
- Align dendrograms even in facetted plots.
- Create multi-panel layouts with ease.
...
- [Special Syntax for Layout Axis](https://yunuuuu.github.io/ggalign/articles/special-syntax.html)
